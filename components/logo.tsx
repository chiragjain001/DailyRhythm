  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      ...
      <span className={cn("font-bold tracking-tight drop-shadow-sm", s.text)}>
        ...
        <span style={{ background: 'linear-gradient(180deg, #FAD961, #F7A93B)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Rhythm</span>
      </span>
    </div>
  )
}
